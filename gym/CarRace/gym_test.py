...
import keyboard
from utils import add_sensors_data_to_observation, pre_processing, get_sensors_data_from_images, get_sensors_pic, scale_image
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # observation_img = cv2.rectangle(np.array(observation_img), (0, 0), (60, 60), (0, 0, 0), -1)
